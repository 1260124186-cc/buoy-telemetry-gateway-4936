# buoy-telemetry-gateway__002 Docker 交付说明
...
```bash
./build_benzhi_docker.sh buoy-telemetry-gateway__002-benzhi linux/amd64
docker run --rm -it buoy-telemetry-gateway__002-benzhi bash
```
